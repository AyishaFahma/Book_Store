  ...
  return (
    ...
    <div className='bg-blue-950' style={{height:'200px'}}></div>
      ...
      <div className='md:px-40 px-5'>
        ...
        {bookStatus && <div className='shadow-lg/30 rounded py-8 md:px-5 px-2 mt-5 border-gray-200 border'>
        ...
        {purchaseStatus && <div className='shadow-lg/30 border-gray-200 border rounded py-8 md:px-5 px-2 mt-5'>
          {/* one book details/content */}
          <div className='bg-gray-200 p-5 rounded mb-5'>
            {/* book details part */}
            <div className="md:grid grid-cols-[5fr_2fr] gap-x-5">
